...
static bool throwSQLiteException(JNIEnv *env, int errorCode, const char *errorMsg) {
    jclass exceptionClass = env->FindClass("android/database/SQLException");
...
Java_org_dany_sqlcipher_driver_SQLCipherDriverKt_nativeThreadSafeMode(
        JNIEnv* env,
        jclass clazz) {
...
Java_org_dany_sqlcipher_driver_SQLCipherDriverKt_nativeOpen(
        JNIEnv* env,
        jclass clazz,
        jstring name,
        int openFlags) {
...
Java_org_dany_sqlcipher_driver_SQLCipherConnectionKt_nativeClose(
        JNIEnv* env,
        jclass clazz,
        jlong dbPointer) {
    sqlite3 *db = reinterpret_cast<sqlite3*>(dbPointer);
...
extern "C" JNIEXPORT void JNICALL
Java_org_dany_sqlcipher_driver_SQLCipherStatementKt_nativeBindBlob(
        JNIEnv* env,
        jclass clazz,
        jlong stmtPointer,
        jint index,
...
extern "C" JNIEXPORT void JNICALL
Java_org_dany_sqlcipher_driver_SQLCipherStatementKt_nativeBindDouble(
        JNIEnv* env,
        jclass clazz,
        jlong stmtPointer,
        jint index,
...
extern "C" JNIEXPORT void JNICALL
Java_org_dany_sqlcipher_driver_SQLCipherStatementKt_nativeBindLong(
        JNIEnv* env,
        jclass clazz,
        jlong stmtPointer,
        jint index,
...
extern "C" JNIEXPORT void JNICALL
Java_org_dany_sqlcipher_driver_SQLCipherStatementKt_nativeBindText(
        JNIEnv* env,
        jclass clazz,
        jlong stmtPointer,
        jint index,
...
extern "C" JNIEXPORT void JNICALL
Java_org_dany_sqlcipher_driver_SQLCipherStatementKt_nativeBindNull(
        JNIEnv* env,
        jclass clazz,
        jlong stmtPointer,
        jint index) {
...
Java_org_dany_sqlcipher_driver_SQLCipherStatementKt_nativeStep(
        JNIEnv *env,
        jclass clazz,
        jlong stmtPointer) {
    sqlite3_stmt *stmt = reinterpret_cast<sqlite3_stmt*>(stmtPointer);
...
Java_org_dany_sqlcipher_driver_SQLCipherStatementKt_nativeGetBlob(
        JNIEnv *env,
        jclass clazz,
        jlong stmtPointer,
        jint index) {
...
Java_org_dany_sqlcipher_driver_SQLCipherStatementKt_nativeGetDouble(
        JNIEnv *env,
        jclass clazz,
        jlong stmtPointer,
        jint index) {
...
extern "C" JNIEXPORT jlong JNICALL
Java_org_dany_sqlcipher_driver_SQLCipherStatementKt_nativeGetLong(
        JNIEnv *env,
        jclass clazz,
        jlong stmtPointer,
        jint index) {
...
Java_org_dany_sqlcipher_driver_SQLCipherStatementKt_nativeGetText(
        JNIEnv *env,
        jclass clazz,
        jlong stmtPointer,
        jint index) {
...
extern "C" JNIEXPORT jint JNICALL
Java_org_dany_sqlcipher_driver_SQLCipherStatementKt_nativeGetColumnCount(
        JNIEnv *env,
        jclass clazz,
        jlong stmtPointer) {
    sqlite3_stmt *stmt = reinterpret_cast<sqlite3_stmt*>(stmtPointer);
...
extern "C" JNIEXPORT jstring JNICALL
Java_org_dany_sqlcipher_driver_SQLCipherStatementKt_nativeGetColumnName(
        JNIEnv *env,
        jclass clazz,
        jlong stmtPointer,
        jint index) {
...
extern "C" JNIEXPORT jint JNICALL
Java_org_dany_sqlcipher_driver_SQLCipherStatementKt_nativeGetColumnType(
        JNIEnv *env,
        jclass clazz,
        jlong stmtPointer,
        jint index) {
...
extern "C" JNIEXPORT void JNICALL
Java_org_dany_sqlcipher_driver_SQLCipherStatementKt_nativeReset(
        JNIEnv* env,
        jclass clazz,
        jlong stmtPointer) {
    sqlite3_stmt* stmt = reinterpret_cast<sqlite3_stmt*>(stmtPointer);
...
extern "C" JNIEXPORT void JNICALL
Java_org_dany_sqlcipher_driver_SQLCipherStatementKt_nativeClearBindings(
        JNIEnv* env,
        jclass clazz,
        jlong stmtPointer) {
    sqlite3_stmt* stmt = reinterpret_cast<sqlite3_stmt*>(stmtPointer);
...
extern "C" JNIEXPORT void JNICALL
Java_org_dany_sqlcipher_driver_SQLCipherStatementKt_nativeClose(
        JNIEnv* env,
        jclass clazz,
        jlong stmtPointer) {
    sqlite3_stmt* stmt = reinterpret_cast<sqlite3_stmt*>(stmtPointer);
